...
class LaneUI:
    def __init__(self, input, bag_file):
    ...
    def load_data(self):
        ...
        for topic in self.input_data:
            print(topic)
            if topic == 'gt_pose_wc':
                gt_pose_msg = self.input_data[topic][0]
            elif topic == 'lanes_gt':
                lanes_gt_msg = self.input_data[topic][0]
            elif topic == 'lanes_predict':
                lanes_predict_msg = self.input_data[topic][0]
            else :
